...
import { genTestUserSig } from '../../debug/GenerateTestUserSig' //文件放入位置 

//@/assets/timsig.js


let options = {
  SDKAppID: 1400750445 // 接入时需要将0替换为您的即时通信 IM 应用的 SDKAppID
};
...
//main.js
let obj = genTestUserSig( '1400750445')
console.log('usering',obj)
tim.login({userID: '1400750445', userSig: obj.userSig});
